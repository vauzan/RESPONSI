...
public class client {
    private  static  final  String BASE_URL="http://192.168.29.1/rental-api/";
    private  static  final  String BASE_URL_IMAGE="http://192.168.29.1/rental-api/upload/avatars/";
    private  static  final  String BASE_URL_IMG="http://192.168.29.1/rental-api/upload/";
